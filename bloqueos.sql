-- Muestra todas las sesiones bloqueadas y quien las esta bloqueando
...
-- Muestra que esta haciendo la sesion bloqueada (suponiendo que sea la sesion 746)
...
-- Query que muestra quien bloquea a quien 
...
-- muestra las sesiones que llevan bloqueadas mas de 15 minutos y los objetos y querys que la bloquean 
...
-- muestra quien esta bloqueando en un RAC 
...
-- quien bloquea a quien dentro de un RAC y tambien muestra los objetos 
...
-- quien bloquea a quien y un poco del decoding 
select	sn.USERNAME,
	m.SID,
	sn.SERIAL#,
	m.TYPE,
...
-- Quien bloquea a quien y el decoding 
